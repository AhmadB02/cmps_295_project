...
<html lang="en" style="background-color: black">
  ...
  <body style="background-color:black; background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Bookme</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/ambulance.png" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 160px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="patsub" value="Login" class="btn btn-primary" style="background-color:black"></center></div>           
