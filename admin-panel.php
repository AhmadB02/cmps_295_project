...
<html lang="en" style="background-color: white;">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Bookme </a>
...
.btn-primary{
  ...
  <body style="padding-top:50px; background-color: white">
  
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif; color:black"> Welcome &nbsp<?php echo $username ?> 
   </h3>
    <div class="row">
